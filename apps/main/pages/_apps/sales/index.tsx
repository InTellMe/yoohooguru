      ...
      <main className="min-h-screen">
        ...
        <section className="section-padding relative overflow-hidden">
          ...
          <div className="relative z-10 container-custom text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-6 animate-fade-in-up">
              Sales <span className="gradient-text-green">Guru</span>
            </h1>
            <p className="text-xl md:text-2xl text-white-80 max-w-3xl mx-auto mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Master sales techniques with top performers and sales experts.
            </p>
            <SasquatchHeroImage subdomain="sales" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              ><span>Start Learning Sales</span>
              ...
              ><span>Become a Sales Guru</span></a></Link>
            </div>

            {/* Stats */}
            <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold gradient-text-green mb-2">143</div>
              ...
              <div className="text-center">
                ...
                <div className="text-sm md:text-base text-white-60 font-medium">Sales Gurus</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold gradient-text-green mb-2">3.5K+</div>
        ...
        <section className="section-padding">
          <div className="container-custom">
            <NewsSection subdomain="sales" limit={5} />
            <div className="mt-16">
              <BlogList subdomain="sales" limit={6} showExcerpts={true} />
            </div>
          </div>
        </section>
          ...
          <div className="container-custom text-center">
            <div className="glass-card p-12 rounded-3xl max-w-4xl mx-auto">
              ...
              <p className="text-xl text-white-80 mb-8">
                Join thousands of sales enthusiasts learning and teaching on YooHoo.Guru
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >Become a Sales Guru</a></Link>
              </div>
            </div>
          </div>
        </section>
      </main>
      <Footer currentDomain="sales" />
    </>
  );
}
